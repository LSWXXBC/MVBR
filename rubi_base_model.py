...
class BaseModel(nn.Module):
    ...
    def forward(self, v, q, labels, bias,v_mask, type_b):
        """Forward
        ...
        if labels is not None:
            ...
            loss=F.binary_cross_entropy_with_logits(rubi_logits, labels, weight=weights)+F.binary_cross_entropy_with_logits(q_out, labels)
            loss *= labels.size(1)
